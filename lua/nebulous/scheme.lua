...
function setup.load_colors(scheme, settings)
  ...
  local editor = {
    ...
    ["@markup.strong"] =       { fg = scheme.White,      bg = scheme.none, style = "bold" },
    ["@markup.raw"] =          { fg = scheme.Grey,       bg = scheme.none, scheme.none },
    ["@markup.link"] =         { fg = scheme.Grey,       bg = scheme.none, scheme.none },
